        ...
        <div class="col-4">
            <div class="grupo-form">
                ...
                <input type="email" id="email" name="email" placeholder="Correo electronico"
                    ...
                    title="Solo se permiten correos de Gmail, Outlook o Hotmail" value="<?php if (isset($_SESSION['datos_form']['email'])) {
                                                                                            echo $_SESSION['datos_form']['email'];
                                                                                        } ?>">

                <input type="text" id="telefono" name="telefono" placeholder="Telefono"
                    required pattern="\d+" maxlength="13"
                    title="El telefono debe contener solo numeros, sin espacios en blanco ni cualquier otro simbolo" value="<?php if (isset($_SESSION['datos_form']['telefono'])) {
        ...
        <div class="col-4">
            <div class="grupo-form">
                ...
                <input type="text" id="estado" name="estado" placeholder="Estado"
                    required pattern="^[A-Za-z]+(?:\s[A-Za-z]+)*$"
                    title="El estado solo puede contener letras y no puede estar vacio o en blanco" value="<?php if (isset($_SESSION['datos_form']['estado'])) {
                ...
                <input type="text" id="municipio" name="municipio" placeholder="Municipio"
                    required pattern="^[A-Za-z]+(?:\s[A-Za-z]+)*$"
                    title="El municipio solo puede contener letras y no puede estar vacio o en blanco" value="<?php if (isset($_SESSION['datos_form']['municipio'])) {
                ...
                <input type="text" id="ciudad" name="ciudad" placeholder="Ciudad"
                    required pattern="^[A-Za-z]+(?:\s[A-Za-z]+)*$"
                    title="La ciudad solo puede contener letras y no puede estar vacio o en blanco" value="<?php if (isset($_SESSION['datos_form']['ciudad'])) {
                ...
                <input type="text" id="calle" name="calle" placeholder="Calle"
                    ...
                    title="La calle no puede estar vacio o en blanco" value="<?php if (isset($_SESSION['datos_form']['calle'])) {
                ...
                <input type="text" id="zip" name="zip" placeholder="Código postal"
                    ...
                    title="El codigo postal debe contener solo numeros, sin puntos y sin espacios en blanco" value="<?php if (isset($_SESSION['datos_form']['zip'])) {
                                                                                                                        echo $_SESSION['datos_form']['zip'];
                                                                                                                    } ?>">


                <input type="text" id="vivienda" name="vivienda" placeholder="Tipo de vivienda"
                    required pattern="^[A-Za-z0-9]+(?:\s[A-Za-z0-9]+)*$"
                    title="La referencia no puede estar vacio o en blanco" value="<?php if (isset($_SESSION['datos_form']['vivienda'])) {
        ...
        <div class="col-4">
            <div class="grupo-form">
                ...
                <input type="text" id="cargo" name="cargo" placeholder="Cargo"
                    required pattern="^[A-Za-z0-9]+(?:\s[A-Za-z0-9]+)*$"
                    title="El cargo no puede estar vacio o en blanco" value="<?php if (isset($_SESSION['datos_form']['cargo'])) {
                                                                                    echo $_SESSION['datos_form']['cargo'];
                                                                                } ?>">

                <input type="text" id="area" name="area" placeholder="Area de trabajo"
                    required pattern="^[A-Za-z0-9]+(?:\s[A-Za-z0-9]+)*$"
                    title="El area de trabajo no puede estar vacio o en blanco" value="<?php if (isset($_SESSION['datos_form']['area'])) {
                ...
                <input type="text" id="salario_base" name="salario_base" placeholder="Salario base"
                    ...
                    title="El salario base debe contener solo numeros, sin puntos y sin espacios en blanco" value="<?php if (isset($_SESSION['datos_form']['salario_base'])) {
