...
<form action="index.php?page=registrar" method="post">
    ...
    <input type="text" id="telefono" name="telefono"
        ...
        title="El telefono debe contener solo numeros, sin espacios en blanco ni cualquier otro simbolo" value="<?php if (isset($_SESSION['datos_form']['telefono'])){ echo $_SESSION['datos_form']['telefono'];} ?>"><br><br>
